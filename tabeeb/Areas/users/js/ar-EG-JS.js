...
language.noDoctorAtThisSpeciality = "لا يوجد اطباء فى هذا التخصص";
language.LikeThisAdvice = "الاعجاب بالنصيحة";
language.dislikeThisAdvice = "الغاء الاعجاب بالنصيحة";
language.thankForSharingAdvice = "شكرا لك على مشاركة النصيحة";
language.adviceNotShared = "لم يتم مشاركة النصيحة";
language.noCommentsExits = "لا يوجد اى تعليقات";
language.validateFielLength = function (min, max) {
    if (min != undefined && max != undefined)
        return "هذا الحقل لابد ان يحتوى على الاقل " + min + " من الحروف وعلى الاكثر " + max + " من الحروف";
    if (max == undefined)
