...
$(function () {
    ...
    loadScripts.done(loadLocalScript('/Areas/users/js/secNav.js'))
    ...
    inputsDate.each(function (i, inp) {
        if ($(inp).prop('type') != 'date')
            loadScripts.then(loadLocalScript("/Content/themes/base/jquery-ui.min.css"))
            .then(loadLocalScript("/Scripts/jquery-ui-1.12.1.min.js"))
            .then($.getScript("https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.1/i18n/jquery-ui-i18n.min.js")
            .done(function () {
                var options = $.extend(
       {},  // empty object
