...
{
    $(context).toggleClass('w3-red').next().toggleClass("w3-show")
        .parents('.appointementRecord').siblings()
        .find('.w3-show').removeClass('w3-show').end()
        .find('.w3-red').toggleClass('w3-red');
}
/*
