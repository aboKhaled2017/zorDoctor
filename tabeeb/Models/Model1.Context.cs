...
namespace tabeeb.Models
{
    ...
    public partial class tabeebekEntities : DbContext
    {
        public tabeebekEntities()
            : base("name=tabeebekEntities")
        {
        }
        ...
        public virtual DbSet<advRelatedPage> advRelatedPages { get; set; }
        public virtual DbSet<adv> advs { get; set; }
        public virtual DbSet<appointement> appointements { get; set; }
        ...
        public virtual DbSet<commentOnAdvice> commentOnAdvices { get; set; }
        ...
        public virtual int deleteAdmin(Nullable<byte> id)
        {
        ...
        public virtual int rearrangeID(string table, string column)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("rearrangeID", tableParameter, columnParameter);
        }
    
        public virtual int updateAppoint(Nullable<int> docID)
        {
            var docIDParameter = docID.HasValue ?
                new ObjectParameter("docID", docID) :
                new ObjectParameter("docID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("updateAppoint", docIDParameter);
        }
    
        public virtual ObjectResult<getSearchResult_Result> getSearchResult(string str, string lang)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getSearchResult_Result>("getSearchResult", strParameter, langParameter);
        }
    }
}
